...
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
# Private Vorstellung mit einbauen? via private/private-Vorstellung.Rmd
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
ShowPrivate <- FALSE  # 
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
# Benutze die Informationen aus der Datei./private/private.R?
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
UsePrivate <- TRUE  # 
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
...
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
Semester <- "WiSe 2023/24"  # Standard Semesterangabe (SoSe XXXX / WiSe XXXX/XX)
...
#- - - - - - - - - - - - - - - - - - - - - - - - -  - - - -  - - - - - - -
defaultFilename <- "MathGrundlDWInfo"
# ------------------------------------------------------------------------
...
SetupArgumentParser <- function() {
    ...
    parser <- add_option(parser, 
                         c("-c", "--clean"), 
                         action = "store_true",
                         help = "Zu Beginn alle temporären Datein löschen")
    # Variable: dls
    parser <- add_option(parser, 
                         c("-d", "--dls"), 
                         action = "store_true",
...
assign("Vorlesungstermine", "", envir = .GlobalEnv)
