...
- Unterjährige Verzinsung gemäß der *deutschen kaufmännische Zinsmethode* ist **linear**, d. h., das Endkapital ist eine *lineare Funktion* der Laufzeit $t$. Es werden keine Zinseszinsen realisiert.
$$K_t = K_0 \cdot \left( 1+ i \cdot t \right)$$

- **Mehrjährige Verzinsung ist exponentiell**, d. h., das Endkapital ist eine *exponentielle Funktion* der Laufzeit $t$. Für kleine Zinsen und kurze Laufzeit (kleiner ein Jahr)  approximiert die exponentielle die lineare Verzinsung  gut.
...
Für den Verkauf eines Produktes liegen zwei Angebote vor: A bietet $20\,000$ Eurosofort und $10\,000$ in 3 Jahren; B bietet je $15\,000$ Euro in einem Jahr und in 2 Jahren. Welches Angebot ist -- bei einer alternativen Verzinsung von $5\,\%$ -- für den Verkäufer günstiger?
...
Der heutige Wert einer zukünftigen Zahlung oder einer zukünftigen Zahlungsreihe wird **Barwert**, **Kapitalwert** oder **Gegenwartswert** genannt.

Die Begriffe Barwert und Kapitalwert bezeichnen bei Projekten (Investitionen, Aktivitäten, Renten) auch den Wert am **Anfang der Projektlaufzeit**. Beginnt das Projekt erst in der Zukunft, dann unterscheiden sich Bar- und Kapitalwert vom Gegenwartswert.

Der Zeitwert am Ende der Laufzeit einer Zahlungsreihe heißt **Endwert**.
