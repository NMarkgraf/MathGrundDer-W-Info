...
$f$ heißt **stetige Funktion**, falls $f$ in jedem Punkt $x_0 \in D$ stetig ist.
...
heißt dann **Sekantensteigung** oder **Durchschnittssteigung** von $f$ im Intervall $[x_0, x_1] \subseteq Z$.

Den Ausdruck $\frac{f(x_1)- f(x_0)}{x_1-x_0}$ nennen wir auch **Differenzenquotient**.
