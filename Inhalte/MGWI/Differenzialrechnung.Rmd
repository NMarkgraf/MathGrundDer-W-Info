...
Unsere Nebenbedingung hat mit $Y=300$ eine Konstante, Leiten wir formal $L(x_1, x_2, \lamba)$ nach $>$ ab,
so erhalten wir:
...
Würden wir also $Y=303$ statt $Y=300$ als Einkommen annehmen, so sollte sich das Nutzenmaximum von $1\,250$ um $\frac{25}{3}\cdot 3 = 25$ auf (etwa) $1\,275$ steigen lassen.
